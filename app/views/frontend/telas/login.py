...
from frontend.tema import (
    COR_PRIMARIA, COR_FUNDO, COR_TEXTO, COR_TEXTO_SUAVE, COR_ERRO, COR_AVISO,
)
...
def tela_login(page: ft.Page, on_sucesso):
    ...
    formulario = card(
        ft.Column(
            [
                ft.Icon(ft.Icons.SPORTS_SOCCER, color=COR_PRIMARIA, size=48),
                ft.Text("Arena Fácil", size=22, weight=ft.FontWeight.BOLD, color=COR_TEXTO),
